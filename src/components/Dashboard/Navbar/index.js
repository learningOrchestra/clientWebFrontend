...
const Navbar = () => {
  ...
  return (
    <Styles.Navbar className="navbar bg-primary">
      ...
      <Styles.Wrapper>
        ...
        <p className="navbar-brand m-0 p-0">Learning Orchestra</p>
      </Styles.Wrapper>
      ...
      <Styles.Wrapper>
        ...
        <div className="item">
          {user?.data && <Avatar src={user?.data?.profileURL} alt={user?.data?.name} />}
        </div>
      </Styles.Wrapper>
